...
For a complete example of using multiple servers, see the [multi-server example](https://github.com/mcp-use/mcp-use/tree/main/libraries/typescript/packages/mcp-use/examples/client/browser/react/multi-server-example.tsx) in our repository.
