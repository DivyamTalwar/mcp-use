...
🌐 MCP Server URL:
   https://your-server-id.run.mcp-use.com/mcp

🔍 Inspector URL:
   https://inspector.mcp-use.com/inspector?autoConnect=https://your-server-id.run.mcp-use.com/mcp
```
...
```json
{
  "mcpServers": {
    "my-server": {
      "url": "https://your-server-id.run.mcp-use.com/mcp"
    }
  }
}
```
...
- [UI Widgets](/typescript/mcp-apps) - Building interactive widgets
- [CLI Reference](/typescript/api-reference/cli-reference#deploy---cloud-deployment) - All deploy and login flags
- [API Reference](/typescript/api-reference/overview) - Complete API documentation
